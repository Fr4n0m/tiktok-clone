...
const NavBar = () => {
  return (
    <footer className={styles.navbar}>
      ...
      <a className="icon-container" href="/discover">
        <svg
          fill="white"
          height="35"
          viewBox="0 0 48 48"
      ...
      <a className="icon-container" href="/upload">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 75 49"
      ...
      <a className="icon-container" href="/inbox">
        <svg
          width="40"
          height="40"
          viewBox="0 0 32 32"
      ...
      <a className="icon-container active" href="/profile">
        <svg
          width="35"
          height="35"
          viewBox="0 0 48 48"
